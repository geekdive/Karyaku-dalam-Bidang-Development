<?php 
 include './config/koneksi.php';
	...
	$upload_url = 'http://'.$server_ip.'/db_makananlanjutan/'.$upload_path; 
	...
	//	$nim = $_POST['vsnim'];	
		...
		$id_kategori =$_POST['vsidkategori'];
...
// $id = $_POST["vspassword"];
		...
		//	$file_url = 'http://192.168.95.20/crudmakanan/uploads/103.jpg';
			...
			//	$sql = "INSERT INTO `tblmakanan` ( `makanan`,`foto_makanan`) VALUES ( '$namamakanan','$file_url');";
				$sql = "UPDATE tblmakanan SET makanan='$namamakanan' ,foto_makanan='$file_url',id_kategori='$id_kategori' WHERE id_makanan='$id_makanan'";
